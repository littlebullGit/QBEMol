...
class Frags:
    ...
    def __init__(
        ...
        # VQE: rotation matrix from original MO basis to canonical MO basis
        # Set by vqe_solver.regenerate_fcidump_with_heff() when VQE solves in
        # canonical (energy-ordered) basis. Used to transform RDMs back to
        # original fragment MO basis for BE assembly. None if not using VQE.
        self.canonical_rotation: Matrix[float64] | None = None
